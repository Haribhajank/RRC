         ...
         {/* Head Image */}
            <div className='flex justify-center flex-wrap my-10'>
                <div className='lg:ml-40 mt-10  justify-center ml-20'>
                    <img className='h-3/4  mr-0'  src={require('../images/Cloner Cube Binary 536x794 1.png')}></img>
                </div>
            ...
            <div className='lg:grid mx-0 lg:gap-20 justify-center align-center h-auto lg:h-screen flex-wrap lg:grid-cols-2'>
                ...
                <div className='bg-black text-white overflow-y-scroll'>
                        ...
                        <img className='mx-10 lg:ml-72' src={require('../images/Rectangle 7.png')}></img></div>
            ...
            <div className='p-5 w-auto flex flex-col justify-center align-center mt-40 mb-60 lg:px-60  flex-wrap'>
                <div className='flex  align-center text-4xl font-black mb-10 f'>Frequently Asked Question
                </div>
            ...
            <div className=''>
                ...
                <div className='flex mx-20 flex-wrap lg:grid lg:grid-cols-4 gap-8 lg:ml-20 mb-20'>
